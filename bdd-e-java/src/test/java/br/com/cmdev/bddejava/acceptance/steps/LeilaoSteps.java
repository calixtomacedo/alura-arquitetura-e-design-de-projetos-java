package br.com.cmdev.bddejava.acceptance.steps;

import org.junit.Assert;

import br.com.cmdev.bddejava.e2e.pages.Browser;
import br.com.cmdev.bddejava.e2e.pages.LeiloesPage;
import br.com.cmdev.bddejava.e2e.pages.LoginPage;
import br.com.cmdev.bddejava.e2e.pages.NovoLeilaoPage;
...
public class LeilaoSteps {
	...
	public void prenche_o_formulario_com_dados_validos() {
		this.leiloesPage = this.novoLeilaoPage.preencheForm("PC Novo", "1500", "10/09/2021");
	}
	...
	public void o_novo_leilao_aparece_na_tabela() {
		this.leiloesPage.existe("PC Novo", "1500", "10/09/2021", "fulano");
		this.browser.clean();
	}
